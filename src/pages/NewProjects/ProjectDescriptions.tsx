export const sockyDescription = (
    <div>a simple collecting game built using Löve and python</div>
);
...
export const journalTexterDescription = (
    <div>
        a journalling web app built with react + SQL in a team of four. i
        handled most backend database interactions
    </div>
);
